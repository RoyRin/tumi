...
export const products: Record<string, Product> = {
  ...
  "tech-pouch-organizer": {
    ...
    warranty: "2 Year Limited Warranty",
    sku: "0145678D",
    description: "Keep your tech essentials organized and protected.",
    isNew: true,
    isBestSeller: true
  },
  "luggage-tag-set": {
    ...
    originalPrice: 85,
    discount: 47,
    images: ["/images/luggage-tag-set.svg"],
    colors: ["Black/Brown"],
    features: [
      "Set of 2 tags",
    ...
    dimensions: "4.5\" x 2.75\" each",
    weight: "0.2 lbs",
    warranty: "2 Year Limited Warranty",
    sku: "0145234D",
    description: "Elegant luggage identification for the discerning traveler.",
    isBestSeller: false
  },
  "rfid-passport-cover": {
    id: "rfid-passport-cover",
    ...
    originalPrice: 105,
    discount: 48,
    images: ["/images/passport-cover.svg"],
    ...
    dimensions: "5.5\" x 4\" x 0.5\"",
    weight: "0.2 lbs",
    warranty: "2 Year Limited Warranty",
    sku: "0145890D",
    description: "Protect your passport and travel documents in style.",
    isBestSeller: false
  },
  "alpha-slg-card-case": {
    id: "alpha-slg-card-case",
    ...
    originalPrice: 125,
    discount: 48,
    images: ["/images/card-case.svg"],
    colors: ["Black", "Anthracite"],
    features: [
      "Ballistic nylon construction",
      "6 card slots",
      "Center pocket for cash",
      "RFID protection",
      "Slim profile",
      "Leather trim"
    ],
    dimensions: "4\" x 3\" x 0.25\"",
    weight: "0.1 lbs",
    warranty: "2 Year Limited Warranty",
    sku: "0145456D",
    description: "Minimalist card case with maximum protection.",
    isBestSeller: false
  }
}
